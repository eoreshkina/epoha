...
export default function Home() {
  ...
  return (
    ...
    <div className="flex flex-col sm:flex-row items-center justify-between">
      <h1 className="text-3xl font-['Limelight'] mb-2 sm:mb-0">EpoHa Studio</h1>
      <nav className="flex flex-col sm:flex-row gap-2 sm:gap-5 font-['Limelight'] text-center sm:absolute sm:left-1/2 sm:transform sm:-translate-x-1/2">
        <Link legacyBehavior={true} href="https://epohastudio.etsy.com" passHref>
          <a className="text-white hover:text-amber-300 transition-colors">Shop</a>
        </Link>
        <Link legacyBehavior={true} href="" passHref>
          <a className="hover:text-purple-400 transition-colors">Collection</a>
         </Link>
